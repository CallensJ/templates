  ...
  const skillsData = [
    {
      ...
      image: 'https://images.unsplash.com/photo-1611081337543-c6c5198eca61?q=80&w=1471',
    ...
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1573408301185-9146fe634ad0?q=80&w=1412',
    ...
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1601121141461-9d6647bca1ed?q=80&w=1472',
    ...
    <section id="savoir-faire" className={styles.savoirFaire}>
      <div className={styles.container}>
        ...
        <div className={styles.sectionHeader}>
          ...
          <p className={styles.sectionSubtitle}>L'alchimie du geste et de la matière</p>
        </div>
        ...
        <div className={styles.skillsWrapper}>
          {skillsData.map((skill) => (
            <div 
              key={skill.id} 
              className={`${styles.skillBlock} ${skill.reversed ? styles.reversed : ''}`}
            >
              {/* Image */}
